...
public static unsafe class Gl {
    public class AttrubuteContainer {
        ...
        public bool TryGetValue(GlAttr attribute, [NotNullWhen(true)] out int? value) {
            var value1 = 0;
            if (SDL_GL_GetAttribute((SDL_GLAttr)(int)attribute, (int*)Unsafe.AsRef(ref value1))) {
                value = value1;
                return true;
            }
            value = null;
        ...
        public int this[GlAttr attribute]
        {
            get {
                var a = 0;
                SDL_GL_GetAttribute((SDL_GLAttr)(int)attribute, (int*)Unsafe.AsRef(ref a)).ThrowIfError();
                return a;
            }
    ...
    public static void MakeCurrent(Window window, IntPtr context) =>
