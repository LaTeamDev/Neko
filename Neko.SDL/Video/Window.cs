...
public unsafe partial class Window : SdlWrapper<SDL_Window> {
    ...
    public bool AlwaysOnTop {
        get => WindowFlags.HasFlag(WindowFlags.AlwaysOnTop);
    ...
    public WindowFlags WindowFlags => (WindowFlags)(ulong)SDL_GetWindowFlags(Handle);
    ...
    public bool Bordered {
        get => !WindowFlags.HasFlag(WindowFlags.Borderless);
        set => SDL_SetWindowBordered(Handle, value).ThrowIfError();
    }

    public bool Focusable {
        get => !WindowFlags.HasFlag(WindowFlags.NotFocusable);
    ...
    public bool Resizable {
        get => WindowFlags.HasFlag(WindowFlags.Resizable);
